...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xD0,6,{0x55,0x05,0x34,0x6B,0x67,0xC0}}, //VGH=3AVDD-AVEE=16V(single),0x VGL=2AVEE-AVDD=-13V(single)  P6  VGLO sel@Slp in/out
	...
	{0xD5,10,{0x8B,0x00,0x00,0x00,0x01,0x83,0x01,0x83,0x01,0x83}}, //set Vcom,0x register be accessble
