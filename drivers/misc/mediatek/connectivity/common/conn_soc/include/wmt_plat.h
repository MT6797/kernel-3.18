...
#define CONSYS_TOP_CFG_BASE		0x180B1000
#define CONSYS_TOP_CKMON_OFFSET		0x0000010C
#define CONSYS_TOP_CKGEN3_OFFSET	0x00000114
#define CONSYS_TOP_CFG_AON_BASE		0x180C1000
#define CONSYS_TOP_CKGEN0_OFFSET	0x00000100
#define CONSYS_PWRCTLCR_OFFSET		0x00000110
#define CONSYS_MAPPING_CR_BASE		0x180E0000
#define CONSYS_CIRQ_STA_OFFSET		0x00000040
typedef enum _ENUM_CONNSYS_DEBUG_CR {
	CONNSYS_CPU_CLK = 0,
	CONNSYS_BUS_CLK = 1,
	CONNSYS_DEBUG_CR1 = 2,
	CONNSYS_DEBUG_CR2 = 3,
	CONNSYS_TOP_CKGEN0 = 4,
	CONNSYS_PWRCTLCR = 5,
	CONNSYS_TOP_CKMON = 6,
	CONNSYS_TOP_CKGEN3 = 7,
	CONNSYS_CIRQ_STA = 8,
	CONNSYS_CR_MAX
